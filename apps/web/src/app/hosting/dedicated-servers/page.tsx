        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold text-white leading-tight">
              Bare-Metal Dedicated Server Power
            </h1>
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              Uncompromised hardware resources, unmetered bandwidth, multi-gigabit connections, and enterprise RAID storage arrays for heavy workloads.
            </p>
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 space-y-4 text-center">
            ...
            <h3 className="text-xl font-bold text-white">100% Dedicated Hardware</h3>
            <p className="text-xs text-white/70 leading-relaxed">
              No shared resources, no hypervisor overhead. Intel Xeon and AMD EPYC processors with IPMI hardware access.
            </p>
          </div>
        </div>
      </section>
