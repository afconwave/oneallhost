        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              White-label cPanel &amp; WHM reseller packages with unmetered bandwidth, automated billing integration, and African Anycast edge nodes.
            </p>
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 space-y-4 text-center">
            ...
            <h3 className="text-xl font-bold text-white">Full WHM Administrative Control</h3>
            <p className="text-xs text-white/70 leading-relaxed">
              Create custom cPanel hosting packages, manage client resource limits, and re-brand everything with your company logo.
            </p>
          </div>
        </div>
      </section>
