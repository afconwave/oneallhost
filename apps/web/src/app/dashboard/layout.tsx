        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-[#EBEBE7]">
              <div className="w-8 h-8 rounded-full bg-[#0D3B85] text-white flex items-center justify-center font-bold text-xs font-mono">
                {initials}
              </div>
            ...
            <div className="relative bg-white w-72 max-w-[80vw] h-full p-4 flex flex-col justify-between shadow-2xl z-10 overflow-y-auto">
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-[#EBEBE7]">
                  <span className="font-bold text-sm text-[#111111]">Dashboard Menu</span>
                  <button
                    type="button"
                    onClick={() => setMobileNavOpen(false)}
              ...
              <div className="pt-4 border-t border-[#EBEBE7]">
                <Link
                  href="/"
                  className="flex items-center gap-2 text-xs font-semibold text-[#6B6E68] hover:text-[#0D3B85]"
                >
