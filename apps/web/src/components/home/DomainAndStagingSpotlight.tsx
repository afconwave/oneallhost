...
export const DomainAndStagingSpotlight: React.FC = () => {
  return (
    <section className="relative z-20 -mt-10 max-w-7xl mx-auto px-4 sm:px-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Card 1: Permanent Domains & Anycast DNS */}
        <div className="p-8 sm:p-10 bg-[#0D3B85] text-white flex flex-col justify-between rounded-2xl relative min-h-[300px]">
          ...
          <div className="mt-8 pt-6 border-t border-white/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <a href="#domains" className="w-full sm:w-auto">
              <Button
                variant="primary"
                size="md"
                className="w-full sm:w-auto bg-white text-[#0D3B85] hover:bg-[#FAFAF9] font-bold text-xs sm:text-sm h-11 px-5 rounded-xl shadow-xs"
              >
        ...
        {/* Card 2: Subdomain Staging & Leases */}
        <div className="p-8 sm:p-10 bg-[#F6F7F5] text-[#111111] flex flex-col justify-between rounded-2xl relative min-h-[300px]">
          <div className="space-y-3">
          ...
          <div className="mt-8 pt-6 border-t border-[#EBEBE7] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <Link href="/rentals" className="w-full sm:w-auto">
              <Button
                variant="primary"
                size="md"
                className="w-full sm:w-auto bg-[#0D3B85] text-white hover:bg-[#1B6FC9] font-bold text-xs sm:text-sm h-11 px-5 rounded-xl shadow-xs"
              >
