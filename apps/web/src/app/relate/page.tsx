        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-3xl sm:text-5xl font-extrabold text-white leading-tight">
              AI Powered Customer Acquisition &amp; SEO Tools
            </h1>
            <p className="text-base sm:text-lg text-white/80 leading-relaxed">
              Automate local business listings, customer review requests, automated social posts, and search engine optimization.
            </p>
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 space-y-4 text-center">
            ...
            <h3 className="text-xl font-bold text-white">Automated Local &amp; Online Growth</h3>
            <p className="text-xs text-white/70 leading-relaxed">
              Boost search rankings and gain new customer leads automatically.
            </p>
          </div>
        </div>
      </section>
